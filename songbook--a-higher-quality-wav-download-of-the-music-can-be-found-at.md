# A higher quality wav download of the music can be found at

---

## 1. Plain Lyrics (DistroKid)

The video and music in the
Video is intended for people to
Play with and remix in whatever
Manner they like under a CC
BY four.zero license
(CC BY four.zero - Free Download)
Under the title of the song
Then list the lyrics, but remove
Any annotation like verse, chorus, etc.
Such as

Can you list the main characters
In the poem below the lyrics?
Create a summary of the story
List the following text below the summary
...
Under the title of the song
Then list the lyrics, but remove
Any ANNOTA-shun like verse, chorus, etc.
